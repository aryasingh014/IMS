...
export const Sidebar: React.FC = () => {
  ...
  const allNavigation = [
    ...
    { id: 'blockers', label: currentRole === 'INTERN' ? 'My Blockers' : 'Active Blockers', icon: AlertCircle, count: summaryData?.kpi?.blockedInterns, badgeColor: 'bg-rose-100 text-rose-700 font-bold border border-rose-300', roles: ['ADMIN', 'TEAM_LEAD', 'INTERN'] },
    ...
    { id: 'ft-evaluation', label: 'FTE Candidates', icon: Award, count: summaryData?.kpi?.ftPotentialCount, badgeColor: 'bg-purple-100 text-purple-700 font-bold border border-purple-300', roles: ['ADMIN', 'TEAM_LEAD'] },
